...
<body>
    ...
    <!-- Main content -->
	 <div class="row no-print" style="text-align:center; font-size:250%" id="demo"></div>
	<div class="pad margin no-print">
      <div class="callout callout-info" style="margin-bottom: 0!important;">
        <h4><i class="fa fa-info"></i> Note:</h4>
        Harap Simpan baik-baik Bukti Booking Anda.
      </div>
    </div>
    ...
    <section class="invoice">
      ...
      <div class="row invoice-info">
		...
		<b>Kode Transaksi : </b><input id="myInput" style="border:none;" readonly type="text" value="<?php echo $kode_transaksi ?>">
		 <div class="row no-print"><button onclick="myFunction()" onmouseout="outFunc()">Copy</button></div><br>
        <br><br>
		</div>
        <!-- /.col -->
      </div>
      ...
      <div class="row">
        ...
        <div class="col-xs-6">
          <p class="lead">Metode pembayaran:</p>  <ul><li> Silakan transfer ke rekenening BCA 8161299278 an/ Yulia Ratri Kurniawati (Min.DP:50%)</li>
			   <li>Setelah melakukan pembayaran, kirim bukti transfer melalui menu kirim bukti </li>
		    </ul>
          <img src="<?php echo base_url();?>/assets/backend/dist/img/credit/visa.png" alt="Visa">
          <img src="<?php echo base_url();?>/assets/backend/dist/img/credit/mastercard.png" alt="Mastercard">
          <img src="<?php echo base_url();?>/assets/backend/dist/img/credit/american-express.png" alt="American Express">
          <img src="<?php echo base_url();?>/assets/backend/dist/img/credit/paypal2.png" alt="Paypal"> <br><br>   
        </div>
        <!-- /.col -->
        <div class="col-xs-6">
          <p class="lead">Batas Waktu Pembayaran : <?php $tgl = date_create($selesai);
														 echo $tgl1 = date_format($tgl,'d m Y H:i');
													?> </p>
        </div>
        <!-- /.col -->
      </div>
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          ...
          <a href="<?php echo site_url()?>"><button type="button" onClick="return confirm('Pastikan simpan bukti booking Anda , sebelum meninggalkan halaman ini')" class="btn btn-success pull-right"><i class="fa fa-credit-card"></i> Selesai
          </button></a>
        </div>
      </div>
    </section>
